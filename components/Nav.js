...
import Eng from '../public/cricPass.png'
function Nav() {

  //bg-gradient-to-r from-blue-800 to-indigo-900 text-neutral-50 shadow-xl"
  return (
    <div className="navbar" style={{background:"#590a78"}}>
      <div className="navbar-start">
        ...
        <Link
          ...
          href="/"
        > <Image src={Eng} alt="eng" style={{width:"100px"}}/>
        </Link>
      </div>
